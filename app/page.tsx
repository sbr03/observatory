...
{/*           {countdown !== null && <p id="countdown">{countdown}</p>} */}
          ...
          <h1>Status: Can update to say that the weather looks promising for Wed.</h1>
          <h1>NEW LOCATION: We will be outside at the Dornsife Center (3509 Spring Garden)</h1>
          <br />
